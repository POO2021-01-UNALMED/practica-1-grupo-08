...
public class ElegirAtraccion {
	...
	class oyenteComboA implements EventHandler<ActionEvent> {
		Cliente clienteNuevo;
		ComboBox<String> comboatr;
		...
		public oyenteComboA(ComboBox<String> comboatr, Cliente cl) {
			clienteNuevo = cl;
			this.comboatr = comboatr;
		...
		public void handle(ActionEvent e) {
			eleccionatr.getChildren().clear();
			eleccionatr.getChildren().addAll(cabecera, op1, op2, op3, op4, op5, op6,op7,op8, respuesta, confirmar);
