 ...
 *Finalidad: Esta clase simula los servicios que ofrece el hotel; restaurante y zona de atracciones.
 ...
 *Cada objeto de esta clase será almacenado en la lista servicios de la clase Hotel.*/
...
public class Servicio implements Serializable {
	 ...
	 *y zona de atracciones del cliente,por tal motivo no tiene parámetro de retorno. Recibe dos variables enteras 
